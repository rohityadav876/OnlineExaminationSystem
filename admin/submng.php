...
?>
        <div id="container">
            <div class="header">
                <img style="margin:10px 2px 2px 10px;float:left;" height="80" width="200" src="../images/logo.gif" alt="OES"/><h3 class="headtext"> &nbsp;Subject managment System </h3><br>
            </div>
...
<?php
        ...
        if (mysql_num_rows($result) == 0) {
            ...
            //editing components
?>
                    <table cellpadding="20" cellspacing="20"  align="center" class="wi" style="text-align:left;margin-left:15em">
                        <tr>
                            <td>Subject Name</td>
