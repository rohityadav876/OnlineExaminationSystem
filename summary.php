...
<html>
  ...
  <body >
      ...
      <div id="container">
     <div class="header">
                <img style="margin:10px 2px 2px 10px;float:left;" height="80" width="200" src="images/logo.gif" alt="OES"/><h3 class="headtext"> &nbsp;Online Examination System  Summery</h3><br>
            </div>
      ...
      <div class="page">
        ...
        <?php
                        while($r=mysql_fetch_array($result)) {
									...
									{
										echo "<td style=\"color:#168\">".htmlspecialchars_decode($r['answered'],ENT_QUOTES)."</td>";
									}
									...
									echo "<td>".htmlspecialchars_decode($r['stdanswer'],ENT_QUOTES). "</td>";
