...
?>
        <div id="container">
            <div class="header">
                <img style="margin:10px 2px 2px 10px;float:left;" height="80" width="200" src="images/logo.gif" alt="OES"/><h3 class="headtext"> &nbsp;Resume Test </h3><br>
            </div>
...
// Navigations
    ...
    <?php
        ...
        if(mysql_num_rows($result)==0) {
            echo"<h3 style=\"color:#0000cc;text-align:center; height:50px; margin-top:01%;\">There are no incomplete exams, that needs to be resumed! Please Try Again..!</h3>";
        }
        else {
        //editing components
            ?>
