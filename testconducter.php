...
else if(isset($_REQUEST['logout']))
{
    ...
    }else if(isset($_REQUEST['next']) || isset($_REQUEST['summary']) || isset($_REQUEST['viewsummary']))
    {
        ...
        {
            if(isset($_REQUEST['markreview']) and isset($_REQUEST['answer']))
            {
                $answer='review';
            }
			...
			else if(isset($_REQUEST['markreview']) )
			{
				$answer='rnu';
			}
            else
            ...
            if(strcmp($answer,"unanswered")!=0)
            {
				...
				else if(strcmp($answer,"rnu")==0)
                {
                    $query="update studentquestion set answered='rnu',stdanswer=null where stdid=".$_SESSION['stdid']." and testid=".$_SESSION['testid']." and qnid=".$_SESSION['qn'].";";
                }
...
<html>
  ...
  <body >
      ...
      <div class="header">
                <img style="margin:10px 2px 2px 10px;float:left;" height="80" width="200" src="images/logo.gif" alt="OES"/><h3 class="headtext"> &nbsp;Exam Begin </h3><br>
            </div>
      ...
      <div class="page">
          ...
          <div class="tc">
              ...
              <table border="0" width="100%" class="ntab">
                <tr>
                  <th style="width:20%;"><h3><span id="timer" class="timerclass"></span></h3></th>
                  <th style="width:30%;"><h4 style="color: #af0a36;">Question No: <?php echo $_SESSION['qn']; ?> </h4></th>
                    <td ><h4 style="color: #F87779; font-size: 14px;"> <input type="checkbox" width="30" height="30" name="markreview" value="mark"> 
                      <span style="font-size: 30px; font-weight: normal;"  >Mark for Review</span>
		    ...
		    <h4 class="p1"><?php  echo htmlspecialchars_decode($r['question'],ENT_QUOTES);?></h4>
            
            </div>
            <div>
     <?php include ("bfor.php");?>       
            </div>
                       
              <table border="0" width="100%" class="ntab">
                  <tr><td>&nbsp;</td></tr>
                  <tr><td style="text-align:left;width:200px" >1. <input type="radio"  name="answer" value="optiona" <?php if((strcmp(htmlspecialchars_decode($r1['answered'],ENT_QUOTES),"review")==0 ||strcmp(htmlspecialchars_decode($r1['answered'],ENT_QUOTES),"answered")==0)&& strcmp(htmlspecialchars_decode($r1['stdanswer'],ENT_QUOTES),"optiona")==0 ){echo "checked";} ?>> <?php echo htmlspecialchars_decode($r['optiona'],ENT_QUOTES); ?></input></td>
                  <td align="left" style="text-align:left;width:200px">3. <input type="radio" name="answer"  value="optionc" <?php if((strcmp(htmlspecialchars_decode($r1['answered'],ENT_QUOTES),"review")==0 ||strcmp(htmlspecialchars_decode($r1['answered'],ENT_QUOTES),"answered")==0)&& strcmp(htmlspecialchars_decode($r1['stdanswer'],ENT_QUOTES),"optionc")==0 ){echo "checked";} ?>> <?php echo htmlspecialchars_decode($r['optionc'],ENT_QUOTES); ?></input></td>
                  </tr>
                  <tr><td  align="left" style="text-align:left;width:200px" >2. <input type="radio" name="answer"  value="optionb" <?php if((strcmp(htmlspecialchars_decode($r1['answered'],ENT_QUOTES),"review")==0 ||strcmp(htmlspecialchars_decode($r1['answered'],ENT_QUOTES),"answered")==0)&& strcmp(htmlspecialchars_decode($r1['stdanswer'],ENT_QUOTES),"optionb")==0 ){echo "checked";} ?>> <?php echo htmlspecialchars_decode($r['optionb'],ENT_QUOTES); ?></input></td>
                  <td align="left" >4. <input type="radio" name="answer"   value="optiond"  <?php if((strcmp(htmlspecialchars_decode($r1['answered'],ENT_QUOTES),"review")==0 ||strcmp(htmlspecialchars_decode($r1['answered'],ENT_QUOTES),"answered")==0)&& strcmp(htmlspecialchars_decode($r1['stdanswer'],ENT_QUOTES),"optiond")==0 ){echo "checked";} ?>> <?php echo htmlspecialchars_decode($r['optiond'],ENT_QUOTES); ?></input></td>
                  </tr>
